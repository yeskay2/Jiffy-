            ...
            <div class="container-fluid ">
                <div class="row ">
                    <div class="col-md-6 col-lg-3" onclick="window.location.href='project.php';" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body">
                                ...
                                <?php
                                $query = "SELECT COUNT(*) as total_project FROM projects WHERE Company_id = $companyId";
                    ...
                    <?php
                        ...
                        $query = "SELECT COUNT(*) as completed_project FROM projects WHERE progress = 100  AND Company_id = $companyId";
                        $result = mysqli_query($conn, $query);
                        if ($result && mysqli_num_rows($result) > 0) {
                            $row = mysqli_fetch_assoc($result);
                           ...
                           <div class="col-md-6 col-lg-3" onclick="window.location.href='project.php?status=completed';" style="cursor: pointer;">
                                <div class="card card-block card-stretch card-height">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-1">
                                            <p class="mb-0">Total Completed Projects</p>
                        ...
                        <div class="col-md-6 col-lg-3" onclick="window.location.href='task.php?taskstatus=Completed&&condition=1&&period=All';" style="cursor: pointer;">
                            <div class="card card-block card-stretch card-height">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-1">
                                        <p class="mb-0">Total Completed Task</p>
                                        <p class="mb-0"><?php echo round($percentageCompleted, 2); ?>%</p> <!-- Display percentage -->
                                    </div>
