                                        ...
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="iq-header-title">
                                              ...
                                              <?php foreach ($profiledata as $profile) { ?>  
                                                <div data-toggle="tooltip" data-placement="top" data-trigger="hover" data-html="true" title="" data-original-title="<i class='fas fa-download'></i>&nbsp;Download"
                                                >
    <a href="#" class="custom-btn1 btn-2 text-center" onclick="downloadqr('<?php echo $profile['email']; ?>')">
        Download QR
    </a>
...
<script>
    ...
    <div class="form-group mb-3">
        <label for="fname">Full Name: <span style="color: red; margin-left: 5px;">*</span></label>
        <input type="text" class="form-control" id="fname" placeholder="Enter your full name" name="name" value="<?php echo $profile['full_name']; ?>" onkeypress="return onlyLetterKey(event)" required>
    </div>
</div>
                                                    ...
                                                    <div class="form-group col-sm-4">
                                                        <div class="form-group mb-3">
                                                            <label for="phoneNumber">Phone Number: <span style="color: red;margin-left:5px">*</span></label>
                                                    ...
                                                    <div class="form-group col-sm-4">
                                                        <div class="form-group mb-3">
                                                            <label for="dob">Date Of Birth: <span style="color: red;margin-left:5px">*</span></label>
                                                    ...
                                                    <div class="form-group col-sm-4">
                                                    <div class="form-group mb-3">
                                                        <label for="salary">Salary: <span style="color: red;margin-left:5px">*</span></label>
                                                ...
                                                <div class="form-group col-sm-4">
                                                        <div class="form-group mb-3">
                                                            <label for="phoneNumber">Department : <span style="color: red;margin-left:5px">*</span></label>
                                                            <input type="text" class="form-control" id="phoneNumber" value="<?php echo $profile['name']; ?>" name="dpt" onkeypress="return onlyNumberKey(event)" maxLength="10" minLength="10" placeholder="Enter phone number" required>
                                                        </div>
                                                    </div>
                                                <div class="form-group col-sm-4">
                                                    <div class="form-group mb-3">
                                                        <label for="role">Role: <span style="color: red;margin-left:5px">*</span></label>
                                                        <input type="text" class="form-control" name="role" placeholder="Role" pattern="^[A-Za-z\s]+$"  title="Please enter a valid role (letters only)" value="<?php echo $profile['user_role']; ?>" required >
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <div class="form-group mb-3">
                                                        <label for="role">Account Number: <span style="color: red;margin-left:5px">*</span></label>
    ...
    <textarea class="form-control" name="address" rows="5" style="line-height: 22px;" required><?php echo trim($profile['address']); ?></textarea>
</div>
