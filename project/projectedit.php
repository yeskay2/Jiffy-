                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="exampleInputText01" placeholder="Enter your project name" name="projectName" required pattern="[A-Za-z]+[0-9\s_-.\s]*" title="Please use atleast one letter" value="<?= $pd['projectname'] ?>">
                                                                <input type="hidden" class="form-control" id="exampleInputText01" placeholder="Enter your project name" name="projectId" value="<?= $pd['projectId'] ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="budget" name="budget" placeholder="Enter project budget" required pattern="\d{4,}(\.\d+)?" title="Please enter numbers only" value="<?= $pd["budget"] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group mb-3">
                                                                <label for="exampleInputText01">Task Name<span class="text-danger" style="font-size:20px">*</span></label>
                                                                <input type="text" class="form-control" id="moduleInput1" placeholder="Enter modules name" pattern="[A-Za-z\s,]+" title="Please enter letters only">
                                                                <p class="mt-1 text-danger" style="font-size:11px;"><i class="fa fa-exclamation-circle mr-1 text-danger"></i>Please enter names, separated by commas, and then press enter</p>
