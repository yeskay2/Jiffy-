    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-lg-4" onclick="window.location.href='requirement.php?model=totalrequirement'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Total Requirement</h5>
                    ...
                    <div class="col-md-6 col-lg-4" onclick="window.location.href='requirement.php?model=applications'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Applications Received</h5>
                    ...
                    <div class="col-md-6 col-lg-4" onclick="window.location.href='requirement.php?model=todayinterview'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Today Interview</h5>
                                    <?php
                                        $today = date('Y-m-d');
                    ...
                    <div class="col-md-6 col-lg-3" onclick="window.location.href='requirement.php?model=shortlisted'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Shortlisted</h5>
                    ...
                    <div class="col-md-6 col-lg-3" onclick="window.location.href='requirement.php?model=selected'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Selected</h5>
                    ...
                    <div class="col-md-6 col-lg-3" onclick="window.location.href='requirement.php?model=rejected'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Rejected</h5>
                    ...
                    <div class="col-md-6 col-lg-3" onclick="window.location.href='requirement.php?model=hired'" style="cursor: pointer;">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body p-4">
                                <div class="top-block d-flex justify-content-between">
                                    <h5 class="hover-text">Hired</h5>
                                    <?php
