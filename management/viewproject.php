                    ...
                    <div class="col-sm-12">
                        <div class="card">
                                            ...
                                            <div class="container">
                                                ...
                                                <?php $ids = 1; ?>
                                                    ...
                                                    <?php foreach ($totalModulesCompletedPercentage as $moduleName => $completionPercentage) { ?>
                                                        <div class="col-lg-3 mb-4 ms-3" onclick="window.location.href='task.php?modules=<?=$moduleName?>&&project_id=<?=$projectId?>&&condition=1'" style="cursor: pointer;">
                                                    ...
                                                    <?php } }?>  
                                                    <div class="col-lg-3 mb-4 ms-3" onclick="window.location.href='task.php?project_id=<?=$projectId?>'" style="cursor: pointer;">
                            ...
                            <div class="container mb-3 projectDetails">
                                <h4 class="p-3 text-center">Activity Description</h4>
                        ...
                        <div class="d-flex">
                            <div class="container mb-3">
                                <h4 class="p-3 text-center fw-bold">Activity Owner</h4>
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <?php                                             
                                            ...
                                            <a href="#" class="iq-media" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="<?=$profileRow['name']?>" onclick="window.location.href='task.php?project_id=<?=$projectId?>&employeeid=<?=$profileRow['id']?>'">
                            ...
                            <div class="container mb-3 projectDetails">
                                ...
                                <div class="border rounded p-3 mb-3 shadow">
                                    ...
                                    <h6 class="ms-5 mb-4"><b>Total Hours&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&emsp;</b><?=$totalhours." "."hours"?></h6>
                                    ...
                                    <h6 class="ms-5 mb-4">
                                        <b>Activity Document&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;:&emsp;</b>
                                        <a href="./../uploads/projects/<?=$documentAttachment?>" download>
                                            Activity_document.pdf<i class="fa fa-download px-2"></i>
                                        </a>
                                    </h6>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center text-center">
                                ...
                                <button class="custom-btn1 btn-2 mt-3 mt-lg-0 mr-3 text-center mb-4" onclick="projectreport('<?php echo $projectid; ?>','<?php echo $projectname; ?>')">Project Report</button>
                                </a>
                            </div>
                        </div>
                    </div>
