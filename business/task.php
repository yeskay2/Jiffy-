...
if (!empty($_GET['employeeid'])) {
    ...
    $sqlTeams = "SELECT * FROM employee WHERE id = $employee AND user_role = 'Business'";
...
if (isset($_GET['project_id'])) {
    ...
    $sqlTeams = "SELECT * FROM objectives WHERE id = $project_id";
    $resultTeams = $conn->query($sqlTeams);
    if ($resultTeams && $resultTeams->num_rows > 0) {
        $teamData = $resultTeams->fetch_assoc();
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                                ...
                                <h4 class="card-title">Your Action Plan</h4>
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="dropdown dropdown-project mr-3">
                                        <div class="dropdown-toggle" id="projectDropdown" data-toggle="dropdown">
                                            <div class="btn bg-body" tabindex="0" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Select Objective">
                                        ...
                                        <div class="dropdown-header">Select Objective</div>
                                    ...
                                    <?php }  ?>
                                        <a href="#" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Add new action plan">
                                            <button class="custom-btn1 btn-2 mt-3 mt-lg-0 mr-3 text-center" data-toggle="modal" data-target="#new-task-modal">Add Action Plan</button>
                                        </a>                                 
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton04">
                                                                        <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="View Action Plan details">
                                                                        ...
                                                                        ?>
                                                                            <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="Edit Action Plan">
                                                                                <a class="dropdown-item" href="edittask.php?id=<?php echo $row['id']; ?>&cod=<?= $condition ?>">
                                                                                    <i class="ri-edit-line mr-2"></i>Edit
                                                                                </a>
                                                                            </div>
                                                                            <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="Delete Action plan">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteConfirmationModalLabel">Delete Action Plan</h5>
        ...
        <div class="modal-dialog  modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header d-block text-center pb-3 border-bttom">
                    <div class="row">
                        <div class="col-lg-10">
                            <h3 class="modal-title" id="exampleModalCenterTitle">New Action Plan</h3>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" id="myForm" onsubmit="submitForm(event)">
                                <div class="form-group mb-3">
                                    <label for="exampleInputText2" class="h5">Objective Name<span class="text-danger" style="font-size:20px">*</span></label>
                                    <select name="projectid" class="selectpicker form-control" data-style="py-0" id="projectSelect" onchange="project(this.value)" data-live-search="true" required>
                                        ...
                                        <?php
                                        $query = "SELECT * FROM objectives  WHERE  Company_id=$companyId  ORDER BY project_name";
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            <label for="exampleInputText2" class="h5">Select Strategy</label>
                                            <select name="modules" class="form-control" data-style="py-0" id="projectmodules" data-live-search="true">
                                                <option value="" disabled selected hidden>Select Strategy</option>
                                                <option value="" class="dropdown-item" disabled>No Strategies found</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            <label for="combinedInput" class="h5">Action Plan<span class="text-danger" style="font-size:20px">*</span></label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="combinedInput" name="taskName" placeholder="Enter action plan or select action plan" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="category" class="selectpicker form-control" data-style="py-0">
                                                <option data-icon="fas fa-tasks">Action Plan</option>
 ...
 <div class="modal-body">
    <div class="row">
        <div class="col-lg-12">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" id="myForm" onsubmit="submitForm(event)">
                <!-- Existing Objective Selection Field -->
                <div class="form-group mb-3">
                    <label for="exampleInputText2" class="h5">Objective Name<span class="text-danger" style="font-size:20px">*</span></label>
                    <select name="projectid" class="selectpicker form-control" data-style="py-0" id="projectSelect" onchange="project(this.value)" data-live-search="true" required>
                        <option disabled selected hidden value="">Others</option>
                ...
                <!-- Other Project Name Input (if 'Others' is selected) -->
                <div class="form-group mb-3" id="otherProjectInput" style="display: none;">
                    <label for="exampleInputText2" class="h5">Other Project Name</label>
                ...
                <!-- New Fields Start -->
                <div class="form-group mb-3">
                    <label for="activitySelect" class="h5">Activity<span class="text-danger" style="font-size:20px">*</span></label>
                    <select name="activity" class="selectpicker form-control" data-style="py-0" id="activitySelect" required>
                ...
                <div class="form-group mb-3">
                    <label for="actionPlanName" class="h5">Action Plan Name<span class="text-danger" style="font-size:20px">*</span></label>
                    <input type="text" class="form-control" id="actionPlanName" placeholder="Enter action plan name" name="actionPlanName" required>
                </div>

                

                <div class="row">
                    <!-- Timeline: Start Date and End Date Fields -->
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <label for="startDate" class="h5">Start Date<span class="text-danger" style="font-size:20px">*</span></label>
                            <input type="date" class="form-control" id="startDate" name="startDate" required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <label for="endDate" class="h5">End Date<span class="text-danger" style="font-size:20px">*</span></label>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="location" placeholder="Specify location" name="location">
                </div>

                <div class="form-group mb-3">
                    <label for="target" class="h5">Target</label>
                    <input type="number" class="form-control" id="target" placeholder="Set a target or goal" name="target">
                </div>

                <div class="form-group mb-3">
                    <label for="assignedExecutives" class="h5">Assigned Executives<span class="text-danger" style="font-size:20px">*</span></label>
                    <select id="assignedExecutives" name="assignedExecutives[]" class="selectpicker form-control" data-style="py-0" data-live-search="true" multiple required>
                        <option value="" disabled>Select Executives</option>
                        <?php
                        $query = "SELECT * FROM employee WHERE active = 'active' AND Company_id = $companyId ORDER BY full_name";
                        $result = mysqli_query($conn, $query);
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            echo '<option value="" disabled>No executives found</option>';
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="form-group mb-3">
                    <label for="dependencies" class="h5">Dependencies (optional)</label>
                    <textarea class="form-control" id="dependencies" rows="2" placeholder="Specify any dependencies for the task" name="dependencies"></textarea>
                </div>
                ...
                <!-- Attachments Field -->
                <div class="form-group mb-0">
                    <label for="attachments" class="h5">Attachments</label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="attachments" name="attachments[]" multiple>
                        <label class="custom-file-label" for="attachments">Upload multiple files</label>
                    </div>
                    <small class="text-muted">Maximum file size: 5 MB</small>
                    <div id="fileSizeError" class="text-danger d-none">File size exceeds 5 MB.</div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-lg-12 text-center">
                        <button type="submit" id="submitButton" class="custom-btn1 btn-2 mt-3">Submit</button>
                    </div>
                </div>
            </form>
        </div>
