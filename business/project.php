                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                                    <?php if ($_SESSION["id"] != 2 && $_SESSION["id"] != 3) { ?>
                                        <h5>Objectives</h5>
                                    <?php } else { ?>
                                        <h4 class="card-title">Objectives Involved</h4>
                                    <?php } ?>
                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                        <?php if ($_SESSION["id"] != 2 && $_SESSION["id"] != 3) { ?>
                                            <div data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Add new Objective">
                                                <a href="#" class="custom-btn1 btn-2 mr-3 text-center" data-target="#new-project-modal" data-toggle="modal">Add Objective</a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content modal-xl">
                            <div class="modal-header d-block text-center pb-3 border-bottom">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <h4 class="modal-title wordspace" id="exampleModalCenterTitle01">New Objective
                                        </h4>
                                    </div>
                                    <div class="col-lg-2">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="objectiveName">Objective Name<span class="text-danger" style="font-size:20px">*</span></label>
                        <input type="text" class="form-control" id="objectiveName" placeholder="Enter Objective Name" name="objectiveName" required pattern="[A-Za-z\s]+" title="Please use only letters and spaces">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="priority">Priority<span class="text-danger" style="font-size:20px">*</span></label>
                        <select name="priority" class="form-control" id="priority" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="department">Department<span class="text-danger" style="font-size:20px">*</span></label>
                ...
                <!-- Key Performance Indicators (KPIs) Field -->
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="kpi">Key Performance Indicators (KPIs)<span class="text-danger" style="font-size:20px">*</span></label>
                        <textarea class="form-control" id="kpi" placeholder="Enter Key Performance Indicators" name="kpi" required></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                                    <label for="exampleInputText040" class="h5"> Objective Description<span class="text-danger" style="font-size:20px"></span></label>
