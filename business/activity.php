                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                                    <?php if ($_SESSION["id"] != 2 && $_SESSION["id"] != 3) { ?>
                                        <h5>Activity</h5>
                                    <?php } else { ?>
                                        <h4 class="card-title">Activities Involved</h4>
                                    <?php } ?>
                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                        <?php if ($_SESSION["id"] != 2 && $_SESSION["id"] != 3) { ?>
                                            <div data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Add new Objective">
                                                <a href="#" class="custom-btn1 btn-2 mr-3 text-center" data-target="#new-project-modal" data-toggle="modal">Add Activity</a>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="View Objective">
                                                            <a class="dropdown-item" href="viewproject.php?projectid=<?php echo $project['id']; ?>">
                                                                <i class="fa fa-eye mr-2"></i>View
                                                            </a>
                                                        </div>
                                                        <?php if ($_SESSION["id"] != 3) { ?>
                                                            <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="Edit Objective">
                                                        ...
                                                        <?php } ?>
                                                        <?php if ($_SESSION["id"] != 2 && $_SESSION["id"] != 3) { ?>
                                                            <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="Delete Objective">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content modal-xl">
                            <div class="modal-header d-block text-center pb-3 border-bottom">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <h4 class="modal-title" id="taskDetailsModalLabel">Objective Details</h4>
                                    </div>
                                    <div class="col-lg-2">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="deleteConfirmationModalLabel">Delete Objective</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label for="exampleInputText01">Objective Name<span class="text-danger" style="font-size:20px">*</span></label>
                                                <input type="text" class="form-control" id="exampleInputText01" placeholder="Enter your Objective name" name="projectName" required pattern="[A-Za-z]+[0-9\s_-.\s]*" title="Please use atleast one letter">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <label for="exampleInputText01">Add Strategies</label>
                                                <input type="text" class="form-control" id="moduleInput" placeholder="Enter Strategies" pattern="[A-Za-z\s,]+" title="Please enter letters only">
                                                <p class="mt-1 text-danger" style="font-size:11px;"><i class="fa fa-exclamation-circle mr-1 text-danger"></i>Please enter Strategies, separated by commas, and then press enter</p>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="budget" name="budget" placeholder="Enter Objective budget" required pattern="\d{4,}(\.\d+)?" title="Please enter numbers only" value="<?= $pd["budget"] ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label for="exampleInputText01">Action Plans</label>
                                                <input type="text" class="form-control" id="moduleInput1" placeholder="Enter Action Plans" pattern="[A-Za-z\s,]+" title="Please enter letters only">
                                                <p class="mt-1 text-danger" style="font-size:11px;"><i class="fa fa-exclamation-circle mr-1 text-danger"></i>Please enter Action Plans, separated by commas, and then press enter</p>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="selectedproject" class="selectpicker form-control" data-style="py-0" required data-live-search="true">
                                                    ...
                                                    <?php
                                                    $query = "SELECT * FROM employee WHERE active='active' AND user_role='Business' AND Company_id = $companyId";
                                                    $result = mysqli_query($conn, $query);
                                                    if ($result && mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            $id = $row['id'];
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label for="shortDescription">Objective Description<span class="text-danger" style="font-size:20px">*</span></label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3 custom-file-small">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="projectDocument">Choose file : Max size 5 MB</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="objectiveDropdown">Objective<span class="text-danger" style="font-size:20px">*</span></label>
                        <select name="objective" class="form-control" id="objectiveDropdown" required>
                            <option value="" disabled selected>Select Objective</option>
                            <option value=""  selected> Objectiv</option>
                            <?php
                            $query = "SELECT * FROM objectives WHERE Company_id = $companyId";
                            $result = mysqli_query($conn, $query);
                            if ($result && mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $id = $row['id'];
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="activityName">Add Activities<span class="text-danger" style="font-size:20px">*</span></label>
                        <input type="text" class="form-control" id="activityName" placeholder="Enter Activity Name" name="activityName[]" required>
                        <small class="text-muted">Use commas to separate multiple activities.</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group mb-4">
                        <label for="resourcesRequired">Resources Required<span class="text-danger" style="font-size:20px">*</span></label>
                        <textarea class="form-control" id="resourcesRequired" placeholder="Enter Resources Required" name="resourcesRequired" rows="2" required></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="startDate">Start Date<span class="text-danger" style="font-size:20px">*</span></label>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="endDate">End Date<span class="text-danger" style="font-size:20px">*</span></label>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="teamMembers">Assigned Team Member<span class="text-danger" style="font-size:20px">*</span></label>
                        <select name="teamMembers[]" class="form-control selectpicker" id="teamMembers" multiple data-live-search="true" required>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="budget">Budget<span class="text-danger" style="font-size:20px">*</span></label>
                        <input type="number" class="form-control" id="budget" placeholder="Enter Budget" name="budget" min="0" step="0.01" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                <div class="form-group">
                                    <label for="exampleInputText040" class="h5">Activity Description<span class="text-danger" style="font-size:20px"></span></label>
