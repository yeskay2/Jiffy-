                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content text-center">
                                    ...
                                    <h4 class="mx-auto my-3">Edit Action Plan Details</h4>
                                </div>
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="modules" class="form-control" data-style="py-0" id="projectmodules1">
                                                        <option value="nill">No Strategies found</option>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="exampleInputText02" class="h5">Action Plan<span class="text-danger" style="font-size:20px">*</span></label>
                                                    <input type="hidden" class="form-control" name="path" required value="<?php echo $_GET["cod"]; ?>">
                                                    <input type="text" class="form-control" id="exampleInputText02" placeholder="Enter Action Plan" name="taskName" required value="<?php echo htmlspecialchars($taskData['task_name']); ?>">
