                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content text-center">
                                    ...
                                    <?php foreach ($projectedit as $pd) : ?>
                                        <h4 class="mx-auto my-3"><?= $pd['projectname'] ?> Details</h4>
                                    <?php endforeach; ?>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="exampleInputText01" placeholder="Enter your Objective name" name="projectName" required pattern="[A-Za-z]+[0-9\s_-.\s]*" title="Please use atleast one letter" value="<?= $pd['projectname'] ?>">
                                                                <input type="hidden" class="form-control" id="exampleInputText01" placeholder="Enter your Objective name" name="projectId" value="<?= $pd['projectId'] ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                <label for="exampleInputText01">Strategies</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group mb-3">
                                                                <label for="exampleInputText01">Action Plans<span class="text-danger" style="font-size:20px">*</span></label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select name="clentid" class="selectpicker form-control" data-style="py-0"  data-live-search="true">
                                                               ...
                                                               <?php
                                                                    ...
                                                                    if ($result && mysqli_num_rows($result) > 0) {
                                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                                            ...
                                                                            $selected = isset($pd['client_id']) && $pd['client_id'] == $id ? 'selected' : '';
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="number" class="form-control" id="totalHours" name="totalhours" required value="<?= $pd["hours"] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                <label for="budget" class="h5">Per Day<span class="text-danger" style="font-size:20px">*</span></label>
                                                                <input type="text" class="form-control" id="hoursPerDay" name="perday" value='<?= $pd['perday_hours'] ?>'>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="selectedproject" class="selectpicker form-control" data-style="py-0" required onchange="projectmanager(this.value)" data-live-search="true">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="location" name="location" placeholder="Enter project location" required pattern="^[A-Za-z0-9\s\-,.!@#$%^&*()_+=?<>{}[\]\/\\|~`':;]+$" title="Please enter valid location" value="<?= $pd['location'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group mb-3">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <textarea class="form-control" id="editor1" placeholder="Short Description" name="shortDescription" required value="<?= $pd["description"] ?>"><?= $pd["description"] ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="form-group mb-3 custom-file-small">
                                                                ...
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input" id="projectDocument" accept=".pdf,.docx" name="projectDocument">
                                                                    <label class="custom-file-label" for="projectDocument">Choose file: Max size 5 MB</label>
                                                                </div>
                                                                <!-- <a class="" href="./../uploads/projects/<?= $pd["documentAttachment"] ?>" download><i class="fa fa-download px-2"></i>Download project document</a> -->
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
