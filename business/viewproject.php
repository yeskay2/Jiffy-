...
if (isset($_GET['projectid'])) {
    ...
    $sqlProject = "SELECT * FROM objectives WHERE id = ?";
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <!--task Card -->
                                    <div class="container">
                                        <h4 class="p-3 text-center">Action Plan Status</h4>
                                    ...
                                    <div class="container mb-3 projectDetails">
                                        <h4 class="p-3 text-center">Objective Description</h4>
                                    ...
                                    <div class="container mb-3 projectDetails">
                                        ...
                                        <div class="border rounded p-3 mb-3 shadow">
                                            ...
                                            <h6 class="ms-5 mb-4"><b>Client Name&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;:&emsp;</b><?= $clentname ?></h6>
                                            <h6 class="ms-5 mb-4"><b>Actual End Date&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;:&emsp;</b><?= $dueDate ?></h6>
                                            <h6 class="ms-5 mb-4"><b>Total Hours&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;:&emsp;</b><?= $totalhours . " " . "hours" ?></h6>
                                            ...
                                            <h6 class="ms-5 mb-4">
                                                <b>Objective Document&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;:&emsp;</b>
                                                <a href="./../uploads/projects/<?= $documentAttachment ?>" download>
                                                    Objective_document.pdf<i class="fa fa-download px-2"></i>
                                                </a>
                                            </h6>
                                        </div>
                                    </div>
