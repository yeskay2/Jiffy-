...
<head>
    ...
    <title>Leave Details | Jiffy</title>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        <?php
                                        $lid = intval($_GET['id']);
                                        $sql = "SELECT tblleaves.id as lid,employee.full_name,employee.id,employee.email,employee.user_role,tblleavetype.LeaveType,
                                                        employee.phone_number,tblleaves.leave_type,tblleaves.from_date,tblleaves.to_date,
                                                        tblleaves.description,tblleaves.posting_date,tblleaves.status,
                                                        tblleaves.remark_date,tblleaves.admin_remark from tblleaves join 
                                                        employee on tblleaves.empid=employee.id 
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td colspan="5" class="text-left"><?php echo htmlentities($row['id']); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Employee Name</th>
                                                <td colspan="5" class="text-left"><?php echo htmlentities($row['full_name']); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Employee Role</th>
                                                <td colspan="5" class="text-left"><?php echo htmlentities($row['user_role']); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Employee Email</th>
                                                <td colspan="5" class="text-left"><?php echo htmlentities($row['email']); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Employee Contact</th>
                                                <td colspan="5" class="text-left"><?php echo htmlentities($row['phone_number']); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Leave Type</th>
                                                <td colspan="5" class="text-left"><?php echo htmlentities($row['LeaveType']); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Leave From</th>
                                                <td colspan="5" class="text-left"><?php echo  date("d-m-Y", htmlspecialchars(strtotime($row['to_date']))); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Leave Upto</th>
                                                <td colspan="5" class="text-left"><?php echo date("d-m-Y", htmlspecialchars(strtotime($row['from_date'])));  ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Leave Applie On</th>
                                                <td colspan="5" class="text-left"><?php echo date("d-m-Y h:s a", htmlspecialchars(strtotime($row['posting_date']))); ?></td>
                                            </tr>
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Status</th>
                                                <td colspan="5" class="text-left"><?php $stats = $row['status'];
                                                                                    if ($stats == 1) {
                                                                                    ?>
                                            ...
                                            <tr>
                                                <th class="text-nowrap text-left" scope="row">Leave Conditions</th>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5" class="text-left"><?php
                                                                                    if ($row['admin_remark'] == "") {
                                                                                        echo "Waiting for Action";
                                                                                    } else {
                                                                                        echo htmlentities($row['admin_remark']);
                                                                                    }
                                                                                    ?></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="5" class="text-left">
                                                    <?php
                                                        if ($row['remark_date'] == "") {
                                                            ...
                                                            echo date("d-m-Y h:s a", htmlspecialchars(strtotime($row['remark_date'])));
                                                        }
                                                        ?></td>
                                            </tr>
