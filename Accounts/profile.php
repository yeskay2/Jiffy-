                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group col-sm-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="accountnumber" placeholder="Enter your account number" pattern="^[A-Za-z\s]+$"  title="Please enter a valid role (letters only)" value="<?php echo $profile['accountnumber']; ?>" required>
                                                    </div>
                                                </div>
