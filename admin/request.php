...
$requestdata = $projectManager->feachrequest($userid);
?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <style>
    /* Apply pointer cursor to table header cells */
    #datatable thead td {
        cursor: pointer;
    }

    /* Optional: Apply pointer cursor to all table cells if needed */
    #datatable tbody td {
        cursor: pointer;
    }
    
    /* Apply pointer cursor for the action buttons */
    .btn {
        cursor: pointer;
    }
</style>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($requestdata as $request) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            ...
                                                            <div>
                                                                <a href="./requestdetials.php?id=<?= $request['Id'] ?>" class="btn btn-yes" style="border-radius: 12px;" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="View request details">
                                                ...
                                                <?php else : ?>
                                                    <td>
                                                        <a href="./requestdetials.php?id=<?= $request['Id'] ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="View">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
                                                <?php endif; ?>                                                    
                            ...
                            <div class="col-lg-12">
                                <form action="" method="post" enctype="multipart/form-data" id="myForm" onsubmit="submitForm(event)">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="type" class="selectpicker form-control" data-style="py-0" required onchange="showFields(this.value)" required>
                                    ...
                                    <div class="row" id="hiringFields" style="display: none;">
                                        <div class="d-flex">
        ...
        <script>
          function showFields(value) {         
            ...
            document.getElementById("otherFields1").style.display = "none";       
