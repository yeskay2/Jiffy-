            ...
            <div id="container">
                ...
                <div id="onlineUsers">
                    ...
                    $sql = "SELECT employee.*, MAX(messages.date) AS latest_message_date
                            ...
                            ORDER BY employee.full_name ASC;"; // Ordered by full_name in ascending order
                    ...
                    while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        <a href="messages.php?userid=<?php echo $row["id"]; ?>">
                            <div class="profile">
                                ...
                                <span class="name mt-4 mx-1 text-dark" style="font-size:12px">
                                    <?= isset($lastmessage) ? $lastmessage : ''; ?>
                                </span>
