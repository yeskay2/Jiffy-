                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                                <?php include("./../project/filter.php"); ?>
                                    ...
                                    ?>
                                                <div class="col-lg-12 task-card1" data-status="<?php echo $row['status']; ?>">
                                                    <div class="card" id="card1">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                <h5 class="mb-3" onclick="window.location.href='viewtask.php?taskid=<?php echo $row['id']; ?>';" style="cursor: pointer;"><?php echo $row['task_name']; ?></h5>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton04">
                                                                        <div data-toggle="tooltip" data-placement="right" data-trigger="hover" title="View task details">
                                                                            <a class="dropdown-item" href="viewtask.php?taskid=<?php echo $row['id']; ?>"><i class="fa fa-eye mr-2"></i>View</a>
                                                                        </div>
                                                                        <?php
    ...
    $(document).ready(function() {
        ...
        $('#selectEmployee').change(function() {
            ...
            if (employeeId && startDate && endDate && startTime && endTime) {
                ...
                $.ajax({
                    url: './../project/employeeavailability.php',
                    type: 'POST',
                    data: data,
                    dataType: 'json',
                    success: function(response) {
