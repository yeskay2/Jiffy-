...
if (isset($_GET["departmentId"]) && !empty($_GET["departmentId"])) {
    ...
    $query = "DELETE FROM roles WHERE id = $departmentId";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $error = "";
    $sucess = "";
    $rolesname = $_POST['roles'];
    $insertQuery = "INSERT INTO roles (name,Company_id) VALUES ('$rolesname','$companyId')";
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="pl-3 btn-new">
                                    <div data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Add new role">
...
?>
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-danger" data-toggle="modal" rel="noopener" href="#myModal<?php echo $departmentId; ?>">
                    <div data-toggle="tooltip" data-placement="bottom" data-trigger="hover" title="Delete role">
        ...
        <!-- Modal HTML -->
        <div id="myModal<?php echo $departmentId; ?>" class="modal fade">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header flex-column">
                        <h4 class="modal-title w-100"><?php echo $name; ?></h4>
                    </div>
                    <div class="modal-body">
                        <h5 class="wordspace">Do you really want to delete this role?</h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-no" data-dismiss="modal">No</button>
                        <a href="role.php?departmentId=<?php echo $departmentId; ?>"><button type="button" class="btn btn-yes">Yes</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header d-block text-center pb-3 border-bttom">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="modal-title wordspace" id="exampleModalCenterTitle02">New Role</h4>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                               ...
                               <input type="text" class="form-control" placeholder="Enter role Name" name="roles" pattern="[^\s]+.*" title="Role name cannot be only spaces" required>
