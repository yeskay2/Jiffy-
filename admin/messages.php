                ...
                <div id="container">
                        ...
                        ?>
                            <div style="display: flex; align-items: center;">
                                ...
                                <div id="userDetail">
                                    ...
                                    <p id="status" style="margin: 0; padding: 10px; <?php echo ($info['status'] === 'Online') ? 'background-color: green; color: white;' : 'background-color: red; color: white;'; ?>">
                            ...
                            <form action="" method="POST" style="margin: 0;">
                                ...
                                <button class="custom-button" type="submit" id="sendMessage" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Start video meet">
                    ...
                    <form action="" id="typingArea">
                        <div id="messagingTypingSection">
                            ...
                            <button class="custom-button" type="submit" id="sendMessage" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="Send message">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'POST',
                url: './../Employee/update_message_status.php', 
                data: {
                    user_id: userid,
                    myid: myid
                },
