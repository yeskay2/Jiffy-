...
#downloadPDF:hover {
    background-color: #d4edda; /* Light green background for PDF */
}

#downloadExcel:hover {
    background-color: #cce5ff; /* Light blue background for Excel */
}


/* Applies hand cursor when hovering over both label and input fields */
