...
require_once "./database/feach.php";
                                            ...
                                            <?php if (!empty($requirementdata)) { ?>
                                                ...
                                                <?php foreach ($requirementdata as $rd) { ?>
                                                    <tbody>
                                                       ...
                                                       <td>
                                                        <button link="https://jiffy.mineit.tech/apply.php?jobid=<?= base64_encode($rd['Id']) ?>&companyid=<?= base64_encode($rd['Company_id']) ?>" type="button" class="btn btn-info" onclick="copyLink('<?= $rd['Id'] ?>')" style="border-radius: 12px;">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="" method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="form-group" id="meetingDateTimeGroup" style="display: none;">
                                                                                ...
                                                                                <input type="datetime-local" class="form-control mb-2" id="meeting_datetime" name="meeting_datetime" required>
